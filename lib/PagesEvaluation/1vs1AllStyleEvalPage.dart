...
class OneToOneAllStyleEvalPage extends StatelessWidget {
  final String selectedJudgeId;
  final String selectedJudgeName;
  final String categoryName;

  OneToOneAllStyleEvalPage(
...
class _JudgingPageState extends State<JudgingPage> {
  ...
  Future<void> actualizarResultados(
    ...
    final firestore = FirebaseFirestore.instance;
    final resultadoRef = firestore.collection('1vs1AllStyle_resultados')
        .doc(participanteId);
        ...
        title: FutureBuilder<String>(
          ...
          builder: (BuildContext context, AsyncSnapshot<String> snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Text('1vs1 All Style: ${snapshot.data}');
            }
          },
        ),
      ),
                    ...
                    return FutureBuilder<List<DropdownMenuItem<String>>>(
                      future: Future.wait(snapshot.data!.docs
                        ...
                        var _participantResult = await FirebaseFirestore
                            .instance
                            .collection('1vs1AllStyle_resultados')
                            .doc(document.id)
                            .get();
