...
class _JudgingPageState extends State<JudgingPage> {
  ...
  Future<void> actualizarResultados(
    ...
    final firestore = FirebaseFirestore.instance;
    final resultadoRef = firestore.collection('3vs3Breaking_resultados')
        .doc(crewId);
  ...
  void _enviarPuntuacion() async {
    if (crewSeleccionada != null && selectedJudgeName != null) {
      try {
        ...
        DocumentSnapshot snapshotCrew = await firestore
            .collection("crews")
            .doc(crewSeleccionada)
            .get();
                  ...
                  if (!snapshot.hasData) {
                    ...
                    return FutureBuilder<List<DropdownMenuItem<String>>>(
                      future: Future.wait(snapshot.data!.docs
                        ...
                        var _crewResult = await FirebaseFirestore
                            .instance
                        ...
                        if (_crewResult.exists) {
                          var _judgeDetails = _crewResult['detalle']
                              [widget.selectedJudgeName];
